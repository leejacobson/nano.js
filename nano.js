...
class Nano {
    ...
    attr(a, v = null) {
        ...
        return this.each(i => i.el[0].setAttribute(a, v));
    }
    ...
    children(s) {
        let els = [];
        this.each(i => els.push(Array.from(i.el[0].children).reduce(curEl => curEl.matches(s))));
        return new Nano(els);
    }
    ...
    css(v) {
        return this.each(i => i.el[0].style.cssText = i.el[0].style.cssText + v);
    }
    ...
    removeAttr(v) {
        return this.each(i => i.el[0].removeAttribute(v));
    }
    ...
    html(v) {
        ...
        return this.each(i => i.el[0].innerHTML = v);
    }
    ...
    _insertAdjacent(v, position) {
        if (typeof v === 'object') {
            ...
            return this.each(i => i.el[0].insertAdjacentElement(position, v));
        } else {
            return this.each(i => i.el[0].insertAdjacentHTML(position, v));
        }
    }
    ...
    empty() {
        return this.each(i => i.el[0].innerHTML = '');
    }
